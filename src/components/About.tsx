      ...
      <div className="container-custom px-5 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-20 items-center">
          ...
          <ScrollAnimation variant="slideLeft">
            ...
            {/* Quote */}
            <div className="relative pl-5 sm:pl-6 border-l-4 border-primary mb-6 sm:mb-8">
              <Quote className="absolute -left-3 -top-2 w-5 h-5 sm:w-6 sm:h-6 text-primary bg-muted/30" />
              ...
              <StaggerContainer staggerDelay={0.15}>
                {differentiators.map((item, index) => (
                  <StaggerItem key={index}>
                    <div className="group p-4 sm:p-5 rounded-xl border border-border bg-card hover:border-primary/30 hover:shadow-lg transition-all duration-300 mb-3 sm:mb-4">
