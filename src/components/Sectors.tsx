...
const sectors = [
  {
    ...
    benefits: [
      "Riduzione no-show del 60%",
      "15+ ore risparmiate a settimana",
      "Agenda piena al 95%",
    ],
  ...
  },
  {
    ...
    benefits: [
      ...
      "Rispondi in 30 secondi h24",
      "10+ ore risparmiate a settimana",
    ],
  ...
  },
  {
    ...
    benefits: [
      "Risparmio 25-30% su ogni ordine",
      "Zero caos durante il servizio",
