      ...
      <main className="pt-32 pb-20">
        <div className="container-custom max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none text-foreground/90 space-y-8">
            <section>
              <h2 className="font-display text-2xl font-bold text-foreground mb-4">1. Premessa</h2>
            ...
            <section>
              <h2 className="font-display text-2xl font-bold text-foreground mb-4">2. Identificazione del Titolare</h2>
            ...
            <section>
              <h2 className="font-display text-2xl font-bold text-foreground mb-4">3. Servizi Offerti</h2>
              <p className="text-muted-foreground leading-relaxed mb-4">ST Solutions offre:</p>
            ...
            <section>
              <h2 className="font-display text-2xl font-bold text-foreground mb-4">4. Utilizzo del Sito</h2>
              <p className="text-muted-foreground leading-relaxed mb-4">L'utente si impegna a:</p>
              <ul className="text-muted-foreground space-y-2 list-disc list-inside">
            ...
            <section>
              <h2 className="font-display text-2xl font-bold text-foreground mb-4">5. Richieste di Preventivo e Contatto</h2>
            ...
            <section>
              <h2 className="font-display text-2xl font-bold text-foreground mb-4">6. Comunicazioni Marketing</h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <section>
              <h2 className="font-display text-2xl font-bold text-foreground mb-4">7. Proprietà Intellettuale</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section>
              <h2 className="font-display text-2xl font-bold text-foreground mb-4">8. Limitazione di Responsabilità</h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
            ...
            <section>
              <h2 className="font-display text-2xl font-bold text-foreground mb-4">9. Garanzia sui Servizi</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section>
              <h2 className="font-display text-2xl font-bold text-foreground mb-4">10. Modifiche ai Termini</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section>
              <h2 className="font-display text-2xl font-bold text-foreground mb-4">11. Legge Applicabile e Foro Competente</h2>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section>
              <h2 className="font-display text-2xl font-bold text-foreground mb-4">12. Contatti</h2>
              <p className="text-muted-foreground leading-relaxed mb-4">
