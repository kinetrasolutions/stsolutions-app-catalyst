...
const Ristorazione = () => {
  ...
  return <div className="min-h-screen">
      ...
      <main>
        ...
        {/* Solutions Section */}
        <section id="soluzioni" className="py-14 md:py-20 px-4 sm:px-6 lg:px-8 bg-muted/50">
          <div className="container-custom">
            <ScrollAnimation variant="fadeUp" className="text-center mb-10 sm:mb-12">
              ...
              <p className="text-base sm:text-lg text-muted-foreground max-w-3xl mx-auto">
                ...
                Implementiamo soluzioni AI che <strong className="text-foreground">riducono drasticamente i tuoi costi operativi</strong> e azzerano gli <strong className="text-foreground">sprechi di tempo</strong>, massimizzando l'efficienza e il <strong className="text-foreground">fatturato del tuo locale.</strong>
              </p>
            </ScrollAnimation>
            ...
            <ScrollAnimation variant="fadeUp" className="mt-8 sm:mt-10">
              <div className="text-center p-6 sm:p-8 rounded-2xl bg-gradient-to-br from-orange-500/10 via-amber-500/5 to-transparent border border-orange-500/20">
          ...
          <div className="container-custom">
            ...
            <StaggerContainer className="grid md:grid-cols-3 gap-4 sm:gap-6">
              {benefits.map((benefit, index) => <StaggerItem key={index}>
                  <div className="h-full rounded-2xl border border-border bg-card p-5 sm:p-6 hover:shadow-xl transition-all duration-300">
                    ...
                    <p className="text-primary font-medium text-sm mb-3">{benefit.subtitle}</p>
        ...
        {/* Results Section */}
        <section className="py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-secondary text-secondary-foreground">
          <div className="container-custom">
              ...
              {results.map((result, index) => {
                ...
                return (
                  <StaggerItem key={index} className="h-full">
                    <div className="h-full rounded-xl bg-white/5 border border-white/10 p-4 sm:p-5 text-center flex flex-col">
                      <div className="flex items-center justify-center gap-2 mb-3">
                        <IconComponent className="w-4 h-4 text-cyan-400" />
                        <p className="text-xs sm:text-sm text-white/60">{result.metric}</p>
                      </div>
                      <div className="flex items-center justify-center gap-2 sm:gap-3 flex-1">
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-sm sm:text-base font-bold text-destructive break-words">{result.before}</p>
                        </div>
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-sm sm:text-base font-bold text-primary break-words">{result.after}</p>
                        </div>
                      </div>
                    </div>
                  </StaggerItem>
        ...
        <section className="py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-orange-500/10 via-background to-amber-500/5 relative overflow-hidden">
          <div className="absolute inset-0">
            <div className="absolute top-1/2 left-1/4 w-48 h-48 bg-orange-500/10 rounded-full blur-3xl" />
            <div className="absolute bottom-1/4 right-1/4 w-36 h-36 bg-amber-500/10 rounded-full blur-2xl" />
          </div>
          
          <div className="container-custom relative z-10">
            <ScrollAnimation variant="fadeUp">
              <div className="max-w-2xl mx-auto text-center">
                <span className="inline-block px-4 py-1.5 rounded-full bg-orange-500/20 text-orange-500 text-sm font-medium mb-4">
                  Inizia Ora
                </span>
        ...
        {/* Process Section */}
        <section id="come-funziona" className="py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-background">
          <div className="container-custom">
            <ScrollAnimation variant="fadeUp" className="text-center mb-8 sm:mb-10">
              <span className="inline-block px-4 py-1.5 rounded-full bg-primary/10 text-primary text-sm font-medium mb-4">
                Il Nostro Processo
            ...
            <StaggerContainer className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
              {processSteps.map(step => <StaggerItem key={step.step} className="h-full">
                  <div className="relative rounded-xl border border-border bg-card p-5 hover:shadow-lg transition-all duration-300 h-full">
                    <div className="absolute -top-3 -left-3 w-8 h-8 rounded-full bg-gradient-to-r from-orange-500 to-amber-500 flex items-center justify-center text-white text-sm font-bold shadow-lg">
                      {step.step}
                    </div>
                    <div className="pt-3">
        ...
        {/* Chi Siamo Section */}
        <section id="chi-siamo" className="py-12 md:py-16 px-4 sm:px-6 lg:px-8 bg-muted/30">
          <div className="container-custom">
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              <ScrollAnimation variant="slideLeft">
                ...
                <div className="relative pl-4 border-l-3 border-orange-500 mb-5">
                  <Quote className="absolute -left-2.5 -top-1.5 w-5 h-5 text-orange-500 bg-muted/30" />
              ...
              <ScrollAnimation variant="slideRight">
                <div className="space-y-3">
                  ...
                  <p className="text-sm sm:text-base font-semibold text-orange-500 mb-4">
                  ...
                  <StaggerContainer staggerDelay={0.1}>
                    ...
                    description: "Non ti vendiamo 'innovazione'. Ti vendiamo tavoli pieni, commissioni azzerate, clienti che tornano. Numeri concreti che si vedono sul conto corrente."
                        ...
                        <div className="group p-4 rounded-lg border border-border bg-card hover:border-orange-500/30 hover:shadow-lg transition-all duration-300 mb-2">
          ...
          <div className="container-custom">
            ...
            <ScrollAnimation variant="fadeUp" className="mb-8">
              <div className="flex flex-wrap justify-center gap-2 max-w-3xl mx-auto">
                {["Ristoranti", "Trattorie", "Pizzerie", "Osterie", "Bistrot", "Wine Bar", "Cocktail Bar", "Pub", "Sushi Bar", "Steakhouse", "Agriturismi", "Catering"].map((profession, index) => <span key={index} className="px-3 py-1.5 rounded-full bg-orange-500/10 text-orange-600 text-xs sm:text-sm font-medium border border-orange-500/20 hover:bg-orange-500/20 transition-colors">
                    {profession}
                  </span>)}
              </div>
            </ScrollAnimation>
            ...
            <StaggerContainer className="grid sm:grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4">
              ...
              description: "I software standard non si adattano al tuo modo di lavorare. Cerchi qualcosa costruito sulle tue esigenze."
                  ...
                  <div className="group p-4 rounded-xl border border-border bg-card hover:border-orange-500/30 hover:shadow-lg transition-all duration-300 h-full">
        ...
        {/* CTA Section */}
        <section className="py-14 md:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-hero">
          <div className="container-custom">
