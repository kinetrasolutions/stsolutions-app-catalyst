...
import { Phone, CalendarX, CreditCard, Bot, ShieldX, UtensilsCrossed, ArrowRight, Check, X, Shield, Zap, Database, MessageSquare, CheckCircle2, ClipboardList, Clock, Package, Quote, type LucideIcon } from "lucide-react";
          ...
          <div className="container-custom">
            <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              ...
              <ScrollAnimation variant="slideLeft">
                <span className="inline-block px-3 py-1 rounded-full bg-orange-100 text-orange-600 text-xs font-medium mb-4 border border-orange-200">
                  Chi Siamo
                </span>
                ...
                {/* Quote */}
                <div className="relative pl-4 sm:pl-5 border-l-4 border-orange-500 mb-5">
                  <Quote className="absolute -left-2.5 -top-1 w-4 h-4 text-orange-500 bg-muted/50" />
                ...
                <div className="space-y-3">
                  ...
                  <StaggerContainer staggerDelay={0.15}>
                    {[
                      ...
                      <StaggerItem key={index}>
                        <div className="group p-4 rounded-xl border border-border bg-card hover:border-orange-300 hover:shadow-lg transition-all duration-300 mb-3">
            ...
            <ScrollAnimation variant="fadeUp" delay={0.2}>
              <div className="mt-12 p-5 sm:p-8 rounded-2xl bg-gradient-to-r from-orange-500 via-amber-500 to-yellow-500 text-white">
